...
<html lang="fr">
  ...
  <body>
    <nav class="navbar navbar-expand-sm navbar-dark bg-danger" style="border-bottom:3px solid #fff">
                ...
                <ul class="navbar-nav mt-2 mt-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownId">
                            ...
                            <a onClick="event.preventDefault(); document.getElementById('deconnection').submit();"

                             class="dropdown-item" href="{{ route('logout') }}">Deconnection</a>

                            <form id="deconnection" action="{{ route('logout') }}" method="post">
